...
## Implementation Note (Current Site)

The live implementation currently runs in a dark-mode adaptation of this system by default. Keep the same structural rules (hard borders, square geometry, mono kickers, no shadows/cards), but use dark surfaces and light editorial text for all primary page regions.
